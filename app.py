...
st.markdown("Моделирование динамики сфиральных узлов с использованием **Золотого вурфа (1,309)**.")
...
for i in range(output_nodes):
    ax.plot(x_values, y_outputs[:, i], label=f"Узел {i+1}", alpha=0.7)
ax.axhline(0, color='black', linewidth=1, alpha=0.5)
ax.set_title("Фазовые состояния сети")
st.pyplot(fig)
